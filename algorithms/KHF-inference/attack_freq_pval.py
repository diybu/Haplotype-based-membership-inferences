...
if __name__ == '__main__':
	...
	path_test = '/data2/diybu/beaconHaplopAttack/haploblock/sampling/posteriorResult/'
        path_null = '/data2/diybu/beaconHaplopAttack/haploblock/sampling/posteriorResult_null/'
